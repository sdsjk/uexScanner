...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, DataJsonVO data){
        ...
        resultPointColor = resources.getColor(EUExUtil
                .getResColorID("plugin_uexscanner_possible_result_points"));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawText(getTipLabel(), width / 2,
    ...
    private Drawable getLineImg(){
        ...
        if (mData.getLineImg() == null){
            lineImg = mContext.getResources().getDrawable(
                    EUExUtil.getResDrawableID("plugin_scanner_scanning"));
        }else{
    ...
    private Drawable getPickBgImg(){
        Drawable pickBgImg;
        if (mData.getLineImg() == null){
            pickBgImg = mContext.getResources().getDrawable(
                    EUExUtil.getResDrawableID("plugin_scanner_frame"));
        }else{
    ...
    private String getTipLabel(){
        String tip = mContext.getResources().getString(
                EUExUtil.getResStringID("plugin_uexscanner_msg_default_status"));
