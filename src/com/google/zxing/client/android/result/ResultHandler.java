...
public abstract class ResultHandler {
  ...
  final void sendMMSFromUri(String uri, String subject, String body) {
    ...
    if (subject == null || subject.isEmpty()) {
      putExtra(intent, "subject", activity.getString(EUExUtil.getResStringID("msg_default_mms_subject")));
    } else {
  ...
  final void launchIntent(Intent intent) {
    try {
      ...
      builder.setTitle(EUExUtil.getResStringID("app_name"));
              builder.setMessage(EUExUtil.getResStringID("msg_intent_failed"));
      builder.setPositiveButton(EUExUtil.getResStringID("button_ok"), null);
              builder.show();
    }
  }
